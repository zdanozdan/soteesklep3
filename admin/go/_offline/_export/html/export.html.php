...
* @version $Id: export.html.php,v 1.10 2004/12/20 17:58:27 maroslaw Exp $
* @package    offline
* @subpackage export
*/
?>
...
<tr>
        <td width=50%  nowrap="nowrap" valign="top">
            ...
            <div align="center">
                ...
                <?php 
                    foreach($lang->export_names_column as $key=>$value) {
...
-->
            ...
            <input type="radio" name=item[command] value="A" id="radio_dump_sql" />
            <label for="radio_dump_sql"><?php print $lang->export_mode['add'];?></label>
             </fieldset>
