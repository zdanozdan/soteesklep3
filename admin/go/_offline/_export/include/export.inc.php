 ...
 * @version $Id: export.inc.php,v 1.24 2005/09/08 13:23:09 lukasz Exp $
 * @package export
 * @subpackage admin
 */
...
class OfflineExport {
    ...
    function OfflineExport() {
		...
		$this->path="$DOCUMENT_ROOT/tmp/soteesklep.csv";
		$this->path1=$shop->home_relink("/tmp/soteesklep.csv");
        $this->path_file="$DOCUMENT_ROOT/tmp/product_tmp";
	...
	*/
    ...
    function select_data() {
		...
		$this->data=$database->sql_select_multi_array4($this->export_column,"main");
        //print "<pre>";
		//print_r($this->data);
		//print "</pre>";
		return true;
