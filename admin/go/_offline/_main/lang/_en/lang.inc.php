...
$lang->offline_load_errors=array(
                ...
                'name'=>"No product name or bad format",
...
$lang->offline_menu=array(
                'load'=>"Load price list",
                'update'=>"Update",
                'status'=>"Status",
                'examples'=>"Examples of price lists",
                'config'=>"Configuration",
                'help'=>"Help",
                );
$lang->offline_upload_info="Attach price list file. Save the file from Excel with tab as the separation character";
$lang->offline_load_all="Load full price list";
$lang->offline_update_action="Update price-list";
$lang->offline_continue="Finish interrupted updating";
$lang->offline_sql_info="<B> Attention!</B><BR>Database will be deleted and replaced with data from loaded
<a href=/go/_offline/index.php><B><u> price list file. </u></b></a><BR>After updating you should call  
<a href=/go/_opt/><B><u>optimization button</u></B></a> in order to update category data.";
$lang->offline_submit_data="Update data";
$lang->offline_examples_price_list="Download example of price-list file:<ul>
<li> <a href=data/soteesklep_en.csv>TXT </a>
</ul>Price-lists in formats sdc,xls and dbf require converting to csv files using StarOffice, OpenOffice or Excel programs.";
