<?php
/**
* Formularz - raport producentów
*
* @author  lech@sote.pl
* @version $Id: q_producers_form.html.php,v 1.5 2004/12/20 17:59:03 maroslaw Exp $
* @package    report
*/
global $lang;
...
?>
<table>
<form action="/go/_report/?report=q_producers" method="POST">
<tr>
...
<tr>
    ...
    <td><?php
            ...
            * Element formularza
            */
            include("./html/input_amount.html.php");
        ?><?php print $lang->report_first;?></td>
