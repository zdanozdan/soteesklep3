 ...
 * @version $Id: list_th.inc.php,v 1.3 2004/12/20 17:58:13 maroslaw Exp $
* @package    edit_producer
 */

/**
 * \@global array  $lang->edit_producer_cols                      nazwy pol formularza
...
function list_th() {
    ...
    reset($lang->edit_producer_cols);$i=1;
    foreach ($lang->edit_producer_cols_list as $col) {
