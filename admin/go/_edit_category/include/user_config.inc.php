<?php
/**
 * Generuj plik konfiguracyjny z wartosciami z tabeli edit_category
 * 
 * @author  m@sote.pl
 * \@template_version Id: user_config.inc.php,v 2.2 2003/06/14 21:59:38 maroslaw Exp
 * @version $Id: user_config.inc.php,v 1.2 2004/12/20 17:58:11 maroslaw Exp $
...
// $__query="SELECT * FROM edit_category";
// require_once ("./include/select.inc.php");
// $gen_config->gen(array("edit_category_data",array($__edit_category_data)));  // edit_category_data -nazwa zmiennej np. $config->edit_category_data
