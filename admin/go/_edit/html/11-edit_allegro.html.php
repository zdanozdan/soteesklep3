...
* @version $Id: edit_allegro.html.php,v 2.5 2006/04/12 11:57:33 scalak Exp $
*
* @package    edit
*/
?>
...
if (@$rec->data['allegro_delivery_sell']=="1") $check_allegro_delivery_sell="checked"; else $check_allegro_delivery_sell="";
...
<tr>
  <td colspan="2"><table border="0" cellpadding="3" cellspacing="3" width="100%">
  		...
  		<input type="checkbox" name=item[allegro_delivery_sell]  value="1" <?php print $check_allegro_delivery_sell; ?>><?php print $lang->edit_allegro['allegro_delivery_sell'];?><br>
  		</td>
  		</tr>
  		</table>
    </td>
