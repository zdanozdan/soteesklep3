...
* @version $Id: configure.html.php,v 1.44 2006/03/09 11:34:24 lukasz Exp $
* @package    configure
*/
...
$form->addSelect("configure[price_type]",$lang->configure_form['price_type'],$lang->price_type,$config->price_type);
