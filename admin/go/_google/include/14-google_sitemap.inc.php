...
*
* @author  m@sote.pl
* @version $Id: google_sitemap.inc.php,v 1.7 2005/09/07 13:14:38 lukasz Exp $
* @package google
*
*
...
class GoogleSitemap {
   ...
   <sitemapindex xmlns=\"http://www.google.com/schemas/sitemap/0.84\">
   <sitemap>
      <loc>http://$config->www/sitemap1.xml.gz</loc>
      <lastmod>$last_mod</lastmod>
   </sitemap>
   <sitemap>
      <loc>http://$config->www/sitemap2.xml.gz</loc>
      <lastmod>$last_mod</lastmod>
   </sitemap>
   </sitemapindex>
   ";
