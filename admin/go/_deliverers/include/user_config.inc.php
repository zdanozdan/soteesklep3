<?php
/**
 * Generuj plik konfiguracyjny z wartosciami z tabeli deliverers
 * 
 * @author  lech@sote.pl
 * @template_version Id: user_config.inc.php,v 2.2 2003/06/14 21:59:38 maroslaw Exp
 * @version $Id: user_config.inc.php,v 1.1 2005/11/18 15:29:34 lechu Exp $
 * @package soteesklep
...
// $__query="SELECT * FROM deliverers";
// require_once ("./include/select.inc.php");
// $gen_config->gen(array("deliverers_data",array($__deliverers_data)));  // deliverers_data -nazwa zmiennej np. $config->deliverers_data
