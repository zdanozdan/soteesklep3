...
print "<td>";$buttons->button($lang->delivery_menu['zone'],"index.php");print "</td>\n";
...
$data=array("<<"=>"/go/_options",
    $lang->delivery_zone_menu["add"]=>"add.php onclick=\"open_window(760,580);\" target=window",
    $lang->delivery_zone_menu["list"]=>"index.php",
