 ...
 * @version $Id: categories.php,v 2.9 2005/01/20 14:59:48 maroslaw Exp $
* @package    discounts
 */
...
// config
$sql="SELECT * FROM discounts WHERE active=1 GROUP BY idc,idc_name ORDER BY idc_name";

$bar=$lang->discounts_list_bar;
$__row_type="category";
$__submit=true;
$__action="update_delete.php";
$__select_action="categories.php";
