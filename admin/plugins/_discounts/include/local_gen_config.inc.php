 ...
 *
 * @author  m@sote.pl
 * @version $Id: local_gen_config.inc.php,v 2.2 2004/12/20 17:59:46 maroslaw Exp $
* @package    discounts
 */
...
$gen_config->vars=array("producer","category","category_producer","default_discounts","discounts_groups","discounts_groups_public"); // jakie zmienne beda generowane
