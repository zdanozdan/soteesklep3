...
/**
 * PHP Template:
 * Usun rekordy z tabeli dictionary
 * 
 * @author m@sote.pl
 * \@template_version Id: delete.php,v 1.3 2003/02/06 11:55:15 maroslaw Exp
 * @version $Id: delete.php,v 2.3 2005/01/20 14:59:47 maroslaw Exp $
* @package    dictionary
 */
...
$theme->bar($lang->dictionary_bar);
print "<p>";

// usun zaznaczone rekordy
require_once("include/delete.inc.php");
$delete = new Delete;
$delete->delete_all("dictionary","id");
