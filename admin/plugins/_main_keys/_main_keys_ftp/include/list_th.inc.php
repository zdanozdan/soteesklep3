 ...
 * @version $Id: list_th.inc.php,v 1.3 2004/12/20 17:59:56 maroslaw Exp $
* @package    main_keys
* @subpackage main_keys_ftp
 */

/**
 * \@global array  $lang->main_keys_ftp_cols                      nazwy pol formularza
...
function list_th() {
    ...
    reset($lang->main_keys_ftp_cols);$i=1;
    foreach ($lang->main_keys_ftp_cols_list as $col) {
