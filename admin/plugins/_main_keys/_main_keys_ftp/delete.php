<?php
/**
 * Usun rekordy z tabeli main_keys_ftp
 * 
 * @author  m@sote.pl
 * \@template_version Id: delete.php,v 2.3 2003/07/11 15:48:09 maroslaw Exp
 * @version $Id: delete.php,v 1.3 2005/01/20 14:59:54 maroslaw Exp $
* @package    main_keys
...
$theme->bar($lang->main_keys_ftp_bar);
print "<p>";

// usun zaznaczone rekordy
require_once("include/delete.inc.php");
$delete = new Delete;
$delete->delete_all("main_keys_ftp","id");
