 ...
 * @version $Id: list_th.inc.php,v 1.4 2004/12/20 18:00:02 maroslaw Exp $
* @package    main_keys
 */

/**
 * \@global array  $lang->main_keys_cols                      nazwy pol formularza
...
function list_th() {
    ...
    reset($lang->main_keys_cols_list);$i=1;
    foreach ($lang->main_keys_cols_list as $col) {
