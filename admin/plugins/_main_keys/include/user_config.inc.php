<?php
/**
 * Generuj plik konfiguracyjny z wartosciami z tabeli main_keys
 * 
 * @author  m@sote.pl
 * \@template_version Id: user_config.inc.php,v 2.2 2003/06/14 21:59:38 maroslaw Exp
 * @version $Id: user_config.inc.php,v 1.2 2004/12/20 18:00:03 maroslaw Exp $
...
// $__query="SELECT * FROM main_keys";
// require_once ("./include/select.inc.php");
// $gen_config->gen(array("main_keys_data",array($__main_keys_data)));  // main_keys_data -nazwa zmiennej np. $config->main_keys_data
