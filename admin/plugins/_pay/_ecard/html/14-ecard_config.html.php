...
<p>
<img src=/themes/base/base_theme/_img/ecard_logo.png align="right"><br />
...
<td>
<input type=text size=70 name=item[ecardServerHash] value='<?php print @$ecard_config->ecardServerHash; ?>' readonly>
</td>
</tr>
...
<td>
<input type=text size=70 name=item[ecardServerPay] value='<?php print @$ecard_config->ecardServerPay; ?>' readonly>
</td>
</tr>
