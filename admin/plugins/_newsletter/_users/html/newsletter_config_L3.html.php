...
* @version $Id: newsletter_config_L3.html.php,v 2.2 2006/03/03 07:52:58 krzys Exp $
*
...
if (@$_REQUEST['item']['choose_lang']=='4'){
 $selected4="selected";   
}elseif (@$_REQUEST['item']['choose_lang']=='3'){
 $selected3="selected";   
}elseif (@$_REQUEST['item']['choose_lang']=='2'){
 $selected2="selected";   
}elseif (@$_REQUEST['item']['choose_lang']=='0'){
 $selected0="selected";   
}
else{
 $selected1="selected";
...
<input type="hidden" name='item[choose_lang]' value="3">
