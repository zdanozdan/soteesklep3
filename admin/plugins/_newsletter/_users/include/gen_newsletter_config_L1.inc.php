<?php
/**
* Generuj plik konfiguracyjny uzytkownika config/auto_config/user_config.inc.php dla jezyka 1
*
* @author  krzys@sote.pl
* @version $Id: gen_newsletter_config_L1.inc.php,v 2.2 2006/03/03 07:53:02 krzys Exp $
*
...
/**
* Zaณฑcz obsณug๊ generowania pliku konfiguracyjnego.
*/
...
$gen_config->config_file="newsletter_config_L1.inc.php";    // generowany plik konfiguracyjny
