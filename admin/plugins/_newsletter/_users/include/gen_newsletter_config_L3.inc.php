<?php
/**
* Generuj plik konfiguracyjny uzytkownika config/auto_config/user_config.inc.php dla jêzyka 3
*
* @author  krzys@sote.pl
* @version $Id: gen_newsletter_config_L3.inc.php,v 2.2 2006/03/03 07:53:02 krzys Exp $
*
...
$gen_config->config_file="newsletter_config_L3.inc.php";    // generowany plik konfiguracyjny
