<?php
/**
* @version    $Id: box1.html.php,v 1.4 2004/12/20 18:01:08 maroslaw Exp $
* @package    themes
*/
...
//$design_mode = "";
    	...
    	print "<table width=\"180\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\"  bgcolor='" . $tc['colors']['box_background'] . "'>\n";
    	print "  <tr>\n";
...
//    	$this->img("_img/_mask.gif");
    	print "\" ></td>\n";
    	print "    <td width=\"100%\" style='color: " . $tc['colors']['base_font'] . ";' bgcolor='" . $tc['colors']['box_background'] . "' align=\"left\">";

    	print "<br><br><center >$lang->themes_contents<br>
    	$lang->search: <input type=text style='width: 40px; border-color: " . $config->theme_config['colors']['input_border'] . "; background-color: " . $config->theme_config['colors']['input_background'] . "; color: " . $config->theme_config['colors']['base_font'] . "'>&nbsp;
    	<button style='border-color: " . $config->theme_config['colors']['button_border'] . "; background-color: " . $config->theme_config['colors']['button_background'] . "; color: " . $config->theme_config['colors']['button_border'] . "'>&gt;</button>
    	</center><br><br>";
