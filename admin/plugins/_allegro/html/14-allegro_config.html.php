...
<table border="0" cellpadding="3" cellspacing="0">
		...
		<td><input type=text size=20 name=item[password] value='<?php print @$allegro_config->allegro_password; ?>'></td>
		<td><?php print $lang->allegro_config['password_test'] ;?>:</td>
		<td><input type=text size=20 name=item[password_test] value='<?php print @$allegro_config->allegro_password_test; ?>'></td>
		</tr>
		<tr>
