 ...
 * @version $Id: list_th.inc.php,v 1.3 2004/12/20 18:00:25 maroslaw Exp $
* @package    partners
 */

/**
 * \@global array  $lang->partners_cols                      nazwy pol formularza
...
function list_th() {
    ...
    reset($lang->partners_cols);$i=1;
    foreach ($lang->partners_cols_list as $col) {
