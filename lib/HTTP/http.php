 ...
 * http.php
 *
 * @(#) $Header: /usr/local/CVS/soteesklep2/lib/HTTP/http.php,v 1.6 2006/03/22 15:29:03 lukasz Exp $
 *
 */
...
class http_class
{
	...
	var $user_agent='httpclient (http://www.phpclasses.org/httpclient $Revision: 1.6 $)';
	...
	// poprawka na home.pl - obejscie problemu czasu ladowania odpowiedzi z serwera wp.pl
	Function GetLine()
	{
		for($line="";;)
		{
			// od teraz jest liczony czas (po flush)
			print " ";
			flush();
			// ustawiamy timeouta na 20 sekund
			stream_set_timeout($this->connection,20);
//			stream_set_blocking($this->connection,false);
			...
			else
			{
				...
				do 
				{
					...
					print "</pre>";*/
					flush();
				} while ($info['timed_out'] || gettype($data)!="string");
			}
