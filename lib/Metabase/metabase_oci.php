 ...
 * metabase_oci.php
 *
 * @(#) $Header: /usr/local/CVS/soteesklep2/lib/Metabase/metabase_oci.php,v 2.1 2003/03/13 11:48:27 maroslaw Exp $
 *
 */
...
class metabase_oci_class extends metabase_database_class
{
	...
	Function RetrieveLOB($lob)
	{
		...
		{
			$lob_object=$this->FetchResult($this->lobs[$lob]["Result"],$this->lobs[$lob]["Row"],$this->lobs[$lob]["Field"]);
