...
//
// $Id: htmlarea.js,v 1.3 2004/07/08 07:39:16 lechu Exp $
...
HTMLArea.Config = function () {
	 ...
	 * upgrading HTMLArea.
	 * 
	 *Wywali³em: "insertimage", "separator", "popupeditor",
	 */
	this.toolbar = [
		[ "fontname", "space",
		  "fontsize", "space",
		...
		[ "justifyleft", "justifycenter", "justifyright", "justifyfull", "separator",
		  ...
		  "inserthorizontalrule", "createlink", "inserttable",  "separator", "showhelp", "about", "separator", "htmlmode" ]
	];
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
	    ...
	    case "showhelp" : window.open(_editor_url + "reference.html", "ha_help", "width=400, height=300, scrollbars=1, resizable=1"); break;
