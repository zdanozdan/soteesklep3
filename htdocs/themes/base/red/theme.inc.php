<?php
/**
* @version    $Id: theme.inc.php,v 1.2 2004/12/20 18:02:46 maroslaw Exp $
* @package    themes
* @subpackage red
*/
...
class MyTheme Extends Theme {
	/**
	* Rozszerzona klasa Theme (Red)
	*
	* @author rp@sote.pl	
	*/
	
    var $bg_bar_color="#CC4446"; // kolory naglowkow
    var $record_odd_color="#ffffff"; // kolor komorki nieparzystej w liscie skroconej (domyslna dla tego tematu "#e0effe")
    var $record_even_color="#FBF0F0"; // kolor komorki parzystej w liscie skroconej (domyslna dla tego tematu "#ffffff")  
