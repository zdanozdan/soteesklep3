<?php
/**
* @version    $Id: theme.inc.php,v 1.3 2004/12/20 18:02:42 maroslaw Exp $
* @package    themes
* @subpackage brown
*/
...
class MyTheme Extends Theme {
	/**
	* Rozszerzona klasa Theme (Brown)
	*
	* @author rp@sote.pl	
	*/
	    
	var $bg_bar_color="#a8662c"; // kolory naglowkow
	var $record_odd_color="#ffffff"; // kolor komorki nieparzystej w liscie skroconej (domyslna dla tego tematu "#e0effe")
    var $record_even_color="#F7F5F4"; // kolor komorki parzystej w liscie skroconej (domyslna dla tego tematu "#ffffff")
    
    // przyciski generowane automatycznie
    var $brown=array(        
		"buttons"=>array(
		    "main.gif"=>"/",
