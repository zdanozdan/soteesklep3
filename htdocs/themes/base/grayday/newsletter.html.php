<?php
/**
* @version    $Id: newsletter.html.php,v 1.2 2004/12/20 18:02:44 maroslaw Exp $
* @package    themes
* @subpackage grayday
*/
global $config, $prefix;
print "<table align=\"center\" width=\"163\" bgcolor=\"" . $config->theme_config['colors']['color_4'] . "\" align=center>";
print "  <tr>";
print "    <td  width=100%>";
