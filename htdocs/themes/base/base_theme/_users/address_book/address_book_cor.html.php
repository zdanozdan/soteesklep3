<?php
/**
* @version    $Id: address_book_cor.html.php,v 1.5 2005/01/18 13:57:06 lechu Exp $
* @package    users
*/
?>
<br />
...
<form action="<?php print $this->action;?>" method="post">
  ...
  <input type="hidden" name="form_cor[id]" value="<?php $this->form_val('id');?>">
  <input type="hidden" name="form_cor[id_users]" value="<?php print $_SESSION['global_id_user'];?>">
  <center>
    <table border="0" cellspacing="0" cellpadding="0" align="center" width="450">
      ...
      <tr> 
        <td align="right"><b><?php print $lang->form_name['street'].", ".$lang->form_name['street_n1']; ?></b> (<?php print $lang->form_name['street_n2'];?>):</td>
        <td>&nbsp;</td>
        <td align="left"> 
      ...
      <tr> 
        <td align="right"><b><?php print $lang->form_name['postcode'].", ".$lang->form_name['city'];?></b>:</td>
        <td>&nbsp;</td>
        <td align="left"> 
      ...
      <tr> 
        ...
        <td>&nbsp;</td>
        <td align="left"> 
          <input type="text" size="20" name="form_cor[country]" value="<?php $this->form_val('country'); ?>">
          <br>
