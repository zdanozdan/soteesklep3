...
* @version    $Id: register_billing.html.php,v 1.2 2006/11/23 17:57:58 tomasz Exp $
* @package    themes
...
if (empty($_POST['corr_addr']) and empty($_SESSION['form_cor']['name'])) {
...
<table width="100%">
<tr>
<td valign="top"><br><?php $this->login_form();?></td>
<td>
<form action="<?php print $this->action;?>" method="post">
  ...
  <center>
    <table border="0" cellspacing="0" cellpadding="3" align="center" width="450">
      <tr> 
        <td  style="text-align: rcenter;"colspan="3"><font size="2"><b> 
      ...
      <tr> 
        ...
        <td align="left" nowrap>
          ...
          ?>
          <a href="/go/_basket/"><?php print @$lang->form_name['change_country'];?></a>
          <br />
      ...
      <tr> 
        ...
        <td align="left" valign="top"> 
          <input class="border0" type="radio" name="form[cor_addr]" value="yes" <?php print $corr_addr_yes; ?>>
          <?php print $lang->yes;?>
          <input class="border0" type="radio" name="form[cor_addr]" value="no" <?php print $corr_addr_no; ?>>
          <?php print $lang->no;?>
        </td>
      </tr>
      <tr> 
...
<table align="right">           
<tr>
<td align="right" style="font: bold 13px Tahoma;color:#808080"><?php print $lang->third_step; ?></td>
</tr><tr>
    <td align="right" >
      <button class="payment" type="submit" name="submit_step_3" value="<?php print $lang->basket_take_order ;?>">
       <?php
