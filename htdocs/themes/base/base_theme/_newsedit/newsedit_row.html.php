...
* @version    $Id: newsedit_row.html.php,v 1.2 2006/11/11 17:08:40 tomasz Exp $
* @package    newsedit
*/
  ...
  <tr> 
    <td bgcolor="#ffffff" style="padding: 8px;" valign="top"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr>
          <td height="30" valign="top" align="left"><?php $this->newsShortDescription(); ?></td>
        </tr>
        <tr> 
          <td><?php $this->newsInfoButton(); ?></td>
        </tr>
      </table>
				</td>
		</tr>
