...
require_once("plugins/_pay/_platnoscipl/include/platnosci.inc.php");
...
//$theme->bar($lang->platnoscipl_title);
global $platnoscipl;
$platnoscipl=new platnoscipl($amount);

$theme->theme_file("_platnosciPL/platnosci_before.html.php");

//print $platnoscipl->form();
