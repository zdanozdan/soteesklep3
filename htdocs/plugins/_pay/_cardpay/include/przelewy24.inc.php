...
*
* @author  m@sote.pl
* @version $Id: przelewy24.inc.php,v 1.1 2005/10/26 12:45:27 lukasz Exp $
* @package przelewy24
*/
...
class Przelewy24 {
    ...
    */
    function _getSessionInfoFromDB($session_id) {
        ...
        $order=$mdbd->select("order_id,total_amount","order_register","session_id=?",array($session_id=>"text"),"ORDER BY id DESC LIMIT 1");

        $_SESSION['p24_kwota']=$order['total_amount']*100;
    ...
    */
    function getInfo($type) {
        ...
        if (! empty($_SESSION['form_cor'])) $form=$_SESSION['form_cor'];
