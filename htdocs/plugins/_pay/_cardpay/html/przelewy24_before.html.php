...
<input type=hidden name="p24_session_id" value="<?php print $sess->id;?>">
...
<input type=hidden name="p24_opis" value="<?php print $basket->orderDescription();?>">
<input type=hidden name="p24_return_url_ok" value="http://<?php print $_SERVER['HTTP_HOST']."/plugins/_pay/_przelewy24/confirm_check.php?sess_id=$sess->id";?>">
<input type=hidden name="p24_return_url_error" value="http://<?php print $_SERVER['HTTP_HOST']."/plugins/_pay/_przelewy24/error.php?sess_id=$sess->id";?>">
